  ...
  head: () => ({
    meta: [
      { title: "Cycle Journey — Perikoma" },
      {
        name: "description",
        content:
          "Explore the four phases of the menstrual cycle — menstrual, follicular, ovulation, and luteal — with a fresh insight each day.",
      },
      { property: "og:title", content: "Cycle Journey — Perikoma" },
      {
        property: "og:description",
        content:
          "The four phases of your cycle: body, hormones, mood, energy, nutrition, and movement.",
      },
